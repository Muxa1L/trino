...
public class VictoriaMetricsPredicateTimeInfo
{
    private final Optional<Instant> predicateLowerTimeBound;
    private final Optional<Instant> predicateUpperTimeBound;

    private VictoriaMetricsPredicateTimeInfo(Optional<Instant> predicateLowerTimeBound, Optional<Instant> predicateUpperTimeBound)
    {
    ...
    public static final class Builder
    {
        ...
        public VictoriaMetricsPredicateTimeInfo build()
        {
            return new VictoriaMetricsPredicateTimeInfo(predicateLowerTimeBound, predicateUpperTimeBound);
        }
    }
}
